  ...
  if(!$result){
        ...
        $user_education_data = $row['user_school'];
         ...
         <div class = 'col-xs-6 col-sm-6 col-md-6 largeimage'>
          ...
          <h4>Seller ID: $user_id</h4>

          <div class ='userinfo'>

          <a href='editbio.php'><button type='button' class='btn btn-primary contact'>Edit bio</button></a>

          <a href='additem.php'><button type='button' class='btn btn-primary contact'>Add item</button></a>

          <a href='mymessages.php'><button type='button' class='btn btn-primary contact'>Messages</button></a>
                                  ...
                                  <a href='items.php?id=$item_id_data'>	<div class='card border-primary mb-3'>
                                      ...
                                      <img class='card-img-top' src='../imgs/$photo_data' alt='Card image cap'>
                                              ...
                                              <div class = 'card-footer'>
                                                <a href='edititem.php?editid=$item_id_data'><button type='button' class='btn btn-primary'>Edit</button></a>
                                                <a href = 'deleteitem.php?deleteid=$item_id_data'><button type ='button' class='btn btn-primary delete'>Delete</button></a>
                                              </div>
