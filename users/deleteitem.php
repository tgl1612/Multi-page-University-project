...
$myeditid = $conn->real_escape_string($_GET['deleteid']);
$deletephoto = "DELETE FROM elmtree_photos WHERE item_id='$myeditid'";
$resultdeletephoto = $conn->query($deletephoto);


$deleteitem = "DELETE FROM elmtree_items WHERE item_id='$myeditid'";
       ...
       <div class= 'col-12 myiteminfo'>
         <div class='row'>
           ...
           <div class='col-12'>
             ...
             <?php
             if($resultdeletephoto && $resultdeleteitem){
               echo "Item deleted successfully!
                      <a href = 'myaccount.php' style='float:right'><button type ='button' class='btn btn-primary'>Back</button></a>
