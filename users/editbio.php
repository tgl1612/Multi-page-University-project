...
$readform = "SELECT * FROM elmtree_users
      ...
      <div class= 'col-12 myiteminfo'>
        <div class='row'>
          ...
          <div class='col-12'>
            ...
            <h5 class ='regwelc1'>Edit Personal Information</h5>

            <form action='editbioprocess.php' method='POST' enctype='multipart/form-data'>
            <?php
              ...
              while($row = $resultform->fetch_assoc()){
                ...
                $user_educ_data = $row['user_school'];
                ...
                echo "
                  ...
                  <div class='form-group'>
                    ...
                    <input type ='password' class='form-control' placeholder ='Type current password' name ='pworiginal'aria-describedby='passHelp'  maxlength = '16'>
                    <input type ='password' class='form-control' style = 'margin-top:1rem' placeholder ='Type new password' name ='pwnew'aria-describedby='passHelp'  maxlength = '16'>
                  ...
                  <div class='form-group'>
                    ...
                    <input type = 'email' class='form-control' name ='editemail' value = '$user_email_data' maxlength = '50'>
                </div>

                <div class='form-group'>
                <label for='editphone'>Edit Phone Number</label>
                <input type='tel' name ='editphone' class='form-control' value = '$user_phone_data' maxlength ='11'>
                </div>
                ...
                <div class='form-group'>
                <label for='editeducation'>Change education</label>
                <input type='text' name = 'editeducation' class='form-control' value = '$user_educ_data' maxlength='25'>
                </div>


                <div class='form-group'>
                  <label for='item_photo1'> Change Profile Photo: </label>
                  <input type='file' name='editfile' id='userphoto' aria-describedby='fileHelp1'>
                  <small id='fileHelp1' class='form-text text-muted'>We accept .jpg, .jpeg or .png files</small>
                </div>
