...
$category_passed_data = $_GET['categories'];

//query to read category button data//
$readcatdata = "SELECT * FROM elmtree_items
                INNER JOIN elmtree_categories ON elmtree_items.category_id = elmtree_categories.category_id
                WHERE elmtree_items.category_id = '$category_passed_data' LIMIT 1";
$resultcatdata = $conn->query($readcatdata);
...
$read = "SELECT * FROM elmtree_items
                ...
                WHERE elmtree_items.category_id = '$category_passed_data'
...
<div class= 'container-fluid mycategoryitems'>
  ...
  <?php
    if(!$resultcatdata){
            ...
            while($row = $resultcatdata->fetch_assoc() ){
