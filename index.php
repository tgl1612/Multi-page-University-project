	  ...
	  <ol class="carousel-indicators">
	   ...
	   <div class="carousel-inner">
	    ...
	    <div class="carousel-item mycarocontainer">
		    <a href="login.php">  <img class="d-block w-100 caro1" src="imgs/shopping3.jpg" alt="Second slide"></a>
				<a href ="login.php">
					<div class="carousel-caption">

	    		<p>Looking to buy something today?</p>
		...
		<div class="carousel-item mycarocontainer">
				<a href="login.php">  <img class="d-block w-100 caro1" src="imgs/shopping6.jpg" alt="Third slide"></a>
				<a href="login.php">
					<div class="carousel-caption">
