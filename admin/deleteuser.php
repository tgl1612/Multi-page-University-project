...
$deleteuser = mysqli_real_escape_string($conn, $_GET['deleteid']);

//query to get item id - to delete photos as well
$getitemid = "SELECT * FROM elmtree_items WHERE user_id= '$deleteuser'";

$resultitemid = $conn->query($getitemid);
...
$deletephoto = "DELETE FROM elmtree_photos WHERE item_id='$itemid'";
$resultdeletephoto = $conn->query($deletephoto);


$deleteitem = "DELETE FROM elmtree_items WHERE user_id ='$deleteuser'";

$resultdeleteitem = $conn->query($deleteitem);



$deleteuserread = "DELETE FROM elmtree_users WHERE user_id='$deleteuser'";

$resultdeleteuser = $conn->query($deleteuserread);
       ...
       <div class= 'col-12 myiteminfo'>
         <div class='row'>
           ...
           <div class='col-12'>
             ...
             <?php
             if($resultdeletephoto && $resultdeleteitem && $resultdeleteuser){
