...
$user_name = 	$_SESSION['40023794_elmtree_user'];
  ...
  $read = "SELECT * FROM elmtree_items INNER JOIN
						elmtree_photos ON elmtree_items.item_id = elmtree_photos.item_id
							...
							<div class="dropdown-menu dropdown-menu-left navdropdown" aria-labelledby="navbarDropdown">
								...
								if(!$result){
									...
									while($row = $resultcat->fetch_assoc() ){
										...
										$category_id_data = $row['category_id'];

										echo"

								<a class='dropdown-item' href='category.php?categories=$category_id_data'>$category_data</a>
									";
	...
	<div id="carouselExampleIndicators" class="carousel slide mycarousel" data-ride="carousel">
	  ...
	  <ol class="carousel-indicators">
	   ...
	   <div class="carousel-inner">
	    <div class="carousel-item active mycarocontainer">

					<a href="myaccount.php">
            	 <img class="d-block w-100 caro1" src="../imgs/belfast2.jpg" alt="First slide">
          </a>
	         <a href="myaccount.php">
						<div class="carousel-caption">
    					<h3>Welcome to Elmtree <?php echo $user_name;   ?>!</h3>
							<p>Belfast's Best Student Buy and Sell</p>
  					</div>
          </a>
  	 </div>

	    <div class="carousel-item mycarocontainer">
		     <img class="d-block w-100 caro1" src="../imgs/shopping3.jpg" alt="Second slide">

					<div class="carousel-caption">

	    		<p>Looking to buy something today?<br>
          Check out our recently added items below!</p>
		...
		<div class="carousel-item mycarocontainer">
				<a href="uploaditem.php">  <img class="d-block w-100 caro1" src="../imgs/shopping6.jpg" alt="Third slide"></a>
				<a href="uploaditem.php">
					<div class="carousel-caption">

						<p>Looking to sell something today?</p>
				</div>
			</a>
		</div>
...
if(!$result){
		...
		while($row = $result->fetch_assoc() ){
			...
			echo "
      <div class = row>
							<div class= 'xs-col-12 sm-col-6 md-col-3 mycardsuser'>
